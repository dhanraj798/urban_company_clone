...
class SubFullWomenHairHalf extends StatefulWidget {
  final String title;

  const SubFullWomenHairHalf({super.key, required this.title});

  @override
  _SubFullWomenHairHalfState createState() => _SubFullWomenHairHalfState();
}

class _SubFullWomenHairHalfState extends State<SubFullWomenHairHalf> {
  ...
  final Map<String, String> _serviceHeadings = {
    'Haircut & spa': 'Packages',
    'Hair spa & style': 'Packages',
    'Haircut & styling': 'Packages',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        extendedPadding: const EdgeInsets.symmetric(horizontal: 2, vertical: 2), // Reduced vertical padding
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildServiceBoxForSection(
                                ...
                                'PACKAGE',
                                'assets/images/hair_spa_style.jpg',
                              ),
                              const SizedBox(height: 16),
                              _buildServiceBoxForSection(
                                'Haircut & styling',
                                ...
                                'PACKAGE',
                                'assets/images/haircut_styling.jpg',
                              ),
                              const SizedBox(height: 8),
                              Divider(color: Colors.grey.shade300),
                            ],
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildServiceBoxForSection(
                                ...
                                '30 mins',
                                [
                                  'Cleanup: Basic face cleansing',
                                  'Includes: Cleansing, steaming',
                                ],
                                'CLEANUP',
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildServiceBoxForSection(
                                ...
                                '20 mins',
                                [
                                  'Bleach: Face brightening',
                                  'Includes: Application, cleansing',
                                ],
                                'BLEACH',
                              ...
                              _buildServiceBoxForSection(
                                ...
                                '30 mins',
                                [
                                  'Detan: Face and neck detan',
                                  'Includes: Application, removal',
                                ],
                                'DETAN',
                                'assets/images/bleach,detan&massage.jpg',
                              ),
